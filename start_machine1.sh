...
open_tab "Worker Logs" "echo 'Waiting for workers to start...'; while [ ! -f logs/worker_3200.log ]; do sleep 2; echo 'Waiting for node allocation...'; done; echo 'Workers detected! Monitoring logs...'; tail -f logs/worker_*.log"
